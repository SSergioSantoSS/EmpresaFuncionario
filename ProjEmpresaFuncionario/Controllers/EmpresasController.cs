...
namespace ProjEmpresaFuncionario.Controllers
{
    ...
    public class EmpresasController : ControllerBase
    {
        ...
        [HttpPut]
        public IActionResult Put(EmpresaPutRequest request)//Update...Alterar//inserir...Create...Cadastrar
        {
            try
            {
        ...
        [HttpDelete("{id}")]//por padrão é sempre necessário passar o parametro 
        public IActionResult Delete(Guid id)//Excluir... Delete
        {
            try
            {
                #region Verificar se o id informado existe no banco de dados
        ...
        [HttpGet]
        public IActionResult GetAll()//Get => Consulta... Read
        {
            try
            {
        ...
        [HttpGet("{id}")]//por padrão é sempre necessário passar o parametro se tiver mais de um separar com/
        public IActionResult GetById(Guid id)//Get => Consulta... Read...se tiver mais de um separar com ,
        {
            try
            {
                var empresa = _empresaRepository.GetById(id);
